...
function createUser($data)
{
    ...
    if ($check_exist['status'] == 1) {
        ...
        if ($User_re) {
            ...
            $mail->Host       = 'useibs.com';                     //Set the SMTP server to send through
            ...
            //Content
            $bodyB = "Hi $fullname! Click on the link to verify your Account https://useibs.com/createpassword.html?id=$last_id&verification=$verification";
...
function verifyEmail($id)
{
    ...
    if ($totalRows_User_re > 0) {
        ...
        //Content
        $bodyB = "Hi $name! Click on the link to verify your Account https://useibs.com/emailverification.html?id=$id&verification=$verification";
        $mail->isHTML(true);                                  //Set email format to HTML
        $mail->Subject = "Account Verification";
        $mail->Body    = ($bodyB);
        $mail->send();
...
function sendContactEmail($data)
{
    ...
    //Recipients
    $mail->setFrom('info@steamledge.com', $email);
    $mail->addAddress('info@steamledge.com');     //Add a recipient
    // $mail->addAddress('ellen@example.com');               //Name is optional
    // $mail->addReplyTo('info@example.com', 'Information');
...
// <?php
// $hostname_ibs = "";
// $database_ibs = "useibs_primeguage";
// $username_ibs = "useibs_primeguage";
// $password_ibs = "prime@2023";
